...
export const 탕수육 = [
	{tag: '점심', ingredient:'돼지고기'},
	{tag: '저녁', ingredient:'감자전분'},
	{tag: '튀김', ingredient:'양파'},
	...
	export const 제육볶음 = [
		...
		export const 해물파전 = [
			...
			{tag: '추울때', ingredient:'부침가루'}
			];
		export const 김치전 = [
			{tag: '부침', ingredient:'신김치'},
			{tag: '점심', ingredient: null},
			{tag: '저녁', ingredient:'청양고추'},
			{tag: '비가올때', ingredient:'계란'},
			{tag: '기름짐', ingredient:'부침가루'},
			{tag: '매운맛', ingredient: null},
			{tag: '비가올때', ingredient: null}
			];
		
		export const 콩국수 = [
			{tag: '더울때', ingredient:'콩국물'},
		...
		export const 화채 = [
			{tag: '더울때', ingredient:'수박'},
			{tag: '단맛', ingredient: '사이다'},
			{tag: '개운함', ingredient:'황도'},
			{tag: null, ingredient:'후르츠믹스'},
			{tag: null, ingredient: null}
			];	
	
			export const 골뱅이소면 = [
				{tag: '무침', ingredient:'골뱅이'},
				{tag: '단맛', ingredient: '당근'},
				{tag: '개운함', ingredient:'양배추'},
				{tag: '매움', ingredient:'소면'},
				{tag: '신맛', ingredient: '사이다'},
				{tag: null, ingredient: '마늘'},
				{tag: null, ingredient: '고추장'},
